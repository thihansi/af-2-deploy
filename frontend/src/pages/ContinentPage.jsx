...
const ContinentPage = () => {
  ...
  const continentData = {
    africa: {
      name: "Africa",
      description: "Africa is the world's second-largest and second-most populous continent. It's known for its diverse wildlife, breathtaking landscapes, and rich cultural heritage.",
    ...
    americas: {
      name: "Americas",
      description: "The Americas comprise North, Central, and South America, along with the Caribbean islands. This diverse continent spans from the Arctic to Antarctica.",
      color: "from-green-600 to-blue-600",
      emoji: "🦅",
      image: "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80",
      funFact: "The Americas have the world's longest mountain range - the Andes!"
    },
    asia: {
      name: "Asia",
      description: "Asia is Earth's largest and most populous continent, home to Mount Everest, the Himalayas, and dozens of diverse cultures and civilizations.",
      color: "from-red-600 to-amber-600",
      emoji: "🐯",
      image: "https://images.unsplash.com/photo-1535139262971-c51845709a48?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80",
      funFact: "Asia has the tallest mountain in the world - Mount Everest!"
    },
    europe: {
      name: "Europe",
      description: "Europe is a continent with a rich history, beautiful architecture, and diverse cultures. Despite being one of the smallest continents, it has many countries.",
    ...
    oceania: {
      name: "Oceania",
      description: "Oceania is a geographic region that includes Australasia, Melanesia, Micronesia, and Polynesia. It's surrounded by the Pacific Ocean and known for its islands.",
      color: "from-blue-400 to-teal-600",
      emoji: "🏝️",
      image: "https://images.unsplash.com/photo-1589330273594-fade1ee91647?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80",
  ...
  useEffect(() => {
    const fetchCountries = async () => {
      try {
        setLoading(true);
        const response = await fetch('https://restcountries.com/v3.1/all?fields=name,flags,cca3,region,subregion,population,capital');
      ...
      <div className="min-h-screen w-full overflow-auto">
        ...
        <div className="relative h-80 md:h-96 mb-8">
          ...
          <div className="absolute inset-0">
            ...
            />
            <div className={`absolute inset-0 bg-gradient-to-b ${currentContinent.color} opacity-70`}></div>
            ...
            <div className="absolute top-8 right-8 max-w-xs">
              <div className="bg-gradient-to-r from-yellow-400/90 to-yellow-500/90 text-blue-900 px-4 py-3 rounded-2xl text-sm font-bold shadow-lg border-4 border-white/30 transform rotate-2">
                <div className="flex items-center mb-1">
                  ...
                  <span className="uppercase tracking-wide text-xs">Fun Fact!</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 relative">
          ...
          <div className="absolute bottom-10 left-0 opacity-30 z-10">
            <img src={shootingStarIcon} alt="Star" className="w-20 h-20 animate-twinkle-slow" />
          </div>
          ...
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm mt-1">
                {countries.length > 0 ? `Discover ${countries.length} amazing countries!` : 'Loading countries...'}
              </p>
            </div>
          </div>
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 animate-pulse">
              {[...Array(15)].map((_, i) => (
                <div key={i} className="h-60 bg-white/10 backdrop-blur-sm rounded-2xl border-4 border-white/10"></div>
              ))}
            </div>
          ) : error ? (
            ...
            <div className="text-center py-16 bg-white/10 backdrop-blur-sm rounded-2xl border-4 border-white/10">
              ...
              <h3 className="text-2xl font-bold text-white mb-3 mt-4">No countries found for {currentContinent.name}</h3>
              <p className="text-blue-200 text-lg mb-6">Try exploring another continent!</p>
              <Link 
                to="/" 
          ...
          <div className="relative h-32 mt-16">
            ...
            <div className="absolute left-1/4 -top-6 transform -translate-x-1/2 rotate-12">
              <img src={starIcon} alt="Sparkle" className="w-16 h-16 animate-bounce-slow" />
            </div>
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
              <img src={rainbow} alt="Rainbow" className="w-32 h-16 animate-float-slow" />
            </div>
            
            {/* Hot air balloon */}
            <div className="absolute right-10 top-0 transform -translate-y-1/2 animate-float">
              <img src={hotAirBalloon} alt="Hot Air Balloon" className="w-16 h-16" />
            </div>
